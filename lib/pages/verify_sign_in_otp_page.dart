...
class VerifySignInOtpPage extends StatefulWidget {
  const VerifySignInOtpPage({Key? key}) : super(key: key);

  static String routeName = '/inputPinPage';

  @override
  State<VerifySignInOtpPage> createState() => _VerifySignInOtpPageState();
}

class _VerifySignInOtpPageState extends State<VerifySignInOtpPage> {
  String otp = '';
